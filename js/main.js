...
(function () {
    ...
    var create_and_append_markers = function (ids) {
        ...
        ids.forEach(function (id) {
            ...
            var $markerContainer = $('<div></div>').addClass('marker-container')
                .css('padding', spacing)
            ...
            var $idLabel = $('<div></div>')
                .addClass('id-label')
                .text(id);
            $markerContainer.append($marker, $idLabel);
            $markers.append($markerContainer);
        });
    };
    ...
    var marker_spacing_callback = function () {
        ...
        if (num) {
            spacing = num;
            $('.marker-container').css('padding', num);
        }
    };
